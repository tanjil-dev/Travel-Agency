                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                /// Favorite
                                Icon(
                                  Icons.favorite_border, color: Color(0xFF007EF2),
                                  size: 28,)
                              ],
                            ),
                            SizedBox(height: 10,),
                            Row(
                              children: [
                                Text("AYANA Resort", style: GoogleFonts.roboto(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w700,
                                  color: Colors.black,
                                ),),
                            ...
                            Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Icon(Icons.location_on, color: Color(0xFF737373), size: 10,),
                                    SizedBox(width: 4,),
                                    Text("Bali, Indonesia", style: GoogleFonts.openSans(fontSize: 10, color: Color(0xFF737373)),)
                                  ],
                                ),
                                SizedBox(height: 5,),
                                Row(
                                  children: [
                                    Text("\$200 - \$500 USD", style: GoogleFonts.roboto(
                                        fontSize: 10, color: Color(0xFF007EF2), fontWeight: FontWeight.w300)),
                                    Text("/night", style: GoogleFonts.roboto(
                                        fontSize: 10, color: Color(0xFF737373), fontWeight: FontWeight.w300),)
                                  ],
                                )
                              ],
                            )
